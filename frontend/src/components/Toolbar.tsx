...
export function Toolbar({ onSearch, onAddDevice, onCreateLink, onAlerts, onSettings, onToggleEditMode, editMode, alertCount = 0 }: ToolbarProps) {
    ...
    return (
        <div className="absolute top-14 right-4 z-10 flex flex-col overflow-hidden rounded-xl border border-border-subtle bg-bg-surface/90 shadow-canvas backdrop-blur-xl">
            {buttons.map((btn, i) => (
                <button
                    key={i}

  ...
  return (
    <>
      ...
      <div className="absolute bottom-16 left-1/2 z-50 -translate-x-1/2 flex flex-col items-center gap-2 pointer-events-none">
        ...
        {showRecoveryToast && (
          <div className="pointer-events-auto flex items-center gap-2.5 rounded-xl border border-status-up/30 bg-surface/95 px-4 py-2.5 shadow-canvas backdrop-blur-sm">
        ...
        {editMode && (
          <div className="pointer-events-auto flex items-center gap-2.5 rounded-xl border border-primary/30 bg-surface/95 px-4 py-2.5 shadow-canvas backdrop-blur-sm">

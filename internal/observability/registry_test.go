...
func TestRegistryHandlerRendersPrometheusSeries(t *testing.T) {
	...
	registry.IncDeviceImportTopologyRunEvent("recovered")
	registry.IncDeviceImportTopologyItemOutcome("unresolved_neighbors")
	registry.IncDeviceImportTopologyRetry("automatic_followup")
	registry.IncDeviceImportTopologyLayout("stale")
	...
	registry.IncWSConnectionEvent("connected")
	registry.IncWSConnectionEvent("disconnected")
	...
	assertContainsMetric(t, body, `theia_device_import_topology_run_events_total{event="recovered"} 1`)
	assertContainsMetric(t, body, `theia_device_import_topology_item_outcomes_total{result="unresolved_neighbors"} 1`)
	assertContainsMetric(t, body, `theia_device_import_topology_retries_total{kind="automatic_followup"} 1`)
	assertContainsMetric(t, body, `theia_device_import_topology_layout_total{result="stale"} 1`)
	...
	assertContainsMetric(t, body, `theia_ws_connections_total{event="connected"} 1`)
	assertContainsMetric(t, body, `theia_ws_connections_total{event="disconnected"} 1`)

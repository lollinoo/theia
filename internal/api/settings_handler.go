...
var validSettingKeys = map[string]bool{
	...
	domain.SettingSNMPPerformanceCounterTimeoutMillis: true,
	domain.SettingSNMPPerformanceCounterRetries:       true,
...
func debugSettingAffects(key string) string {
	...
	case domain.SettingPollingInterval,
		...
		domain.SettingSNMPPerformanceCounterTimeoutMillis,
		domain.SettingSNMPPerformanceCounterRetries,

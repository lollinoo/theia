...
function MikroTikIcon({ size }: { size: number }) {
  return (
    <svg viewBox="0 0 24 24" width={size} height={size} fill="none" aria-hidden="true">
      ...
      {/* Signal waves */}
      <path d="M7.5 9C9 7 10.3 6 12 6C13.7 6 15 7 16.5 9" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
      <path d="M5 6.5C7.2 3.8 9.3 2.5 12 2.5C14.7 2.5 16.8 3.8 19 6.5" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
      {/* Base plate */}
...
function GenericIcon({ size }: { size: number }) {
  return (
    <svg viewBox="0 0 24 24" width={size} height={size} fill="none" aria-hidden="true">
      ...
      {/* Pins */}
      <path d="M9 3.5V6M12 3.5V6M15 3.5V6M9 18V20.5M12 18V20.5M15 18V20.5M3.5 9H6M3.5 12H6M3.5 15H6M18 9H20.5M18 12H20.5M18 15H20.5"

...
// This file defines area repo persistence behavior, ordering guarantees, and not-found conventions.
...
// AreaRepo implements domain.AreaRepository using PostgreSQL.
type AreaRepo struct {
	db *DB
}

// NewAreaRepo creates a new PostgreSQL-backed area repository.

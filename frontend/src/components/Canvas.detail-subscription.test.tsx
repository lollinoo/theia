/**
 * Exercises canvas detail subscription component behavior so refactors preserve the documented contract.
 */
...
describe('Canvas detail subscription', () => {
  ...
  it('passes responsive placement classes to the minimap without changing its behavior props', () => {
    ...
    expect(minimapProps.className).toContain('!bottom-[calc(1rem+env(safe-area-inset-bottom))]');

...
// This file defines vendor config repo persistence behavior, ordering guarantees, and not-found conventions.
...
// VendorConfigRepo implements domain.VendorConfigRepository using PostgreSQL.

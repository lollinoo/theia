...
export function Toolbar({
  ...
  return (
    <div className="topology-glass topology-floating-shadow absolute right-4 top-20 z-10 flex flex-col gap-1 rounded-[16px] p-1.5 transition-colors duration-200">
      <button
        type="button"

...
// This file defines settings constraints domain contracts and lifecycle invariants.
...
var SettingConstraints = map[string]SettingConstraint{
	...
	SettingSNMPPerformanceCounterTimeoutMillis: intConstraint(100, 30000),
	SettingSNMPPerformanceCounterRetries:       intConstraint(0, 10),
